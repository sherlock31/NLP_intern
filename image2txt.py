...
def image2txt(imagepath):
	...
	text_temp = imagepath.replace('.jpg','.txt')						#Name of the text file will be same as the name of the image
	file_output = open(text_temp,'w')									#Opening a text file for writing
